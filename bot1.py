...
MAX_WORKERS = 25      # Eş zamanlı işlem kapasitesi
...
def get_master_symbol_list():
    """Eski geniş kapsamlı ve dinamik coin liste havuzu."""
    all_symbols = set()
...
if __name__ == "__main__":
    print(f"🔄 Tamamen Bağımsız & Paralel Tarama Başladı: {datetime.now()}")
    ...
    # Tüm coinler ve aktif periyotlar ortak bir görev listesinde birleştirilir
    tasks = []
    for sym in symbols:
    ...
    # Tek havuz üzerinden tüm istekler aynı anda (paralel) atılır
